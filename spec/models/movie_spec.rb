describe 'Movie' do
  ...
  context '::new' do
    xit 'can be instantiated without any attributes' do
      expect{Movie.new}.to_not raise_error
    end

    xit 'can be instantiated with a hash of attributes' do
  ...
  context 'basic CRUD' do
    context 'creating' do
      xit 'can be instantiated and then saved' do
      ...
      xit 'can be created in a block when no args are passed' do
      ...
      xit 'can be created in a block' do
    ...
    context 'reading' do
      ...
      xit 'can get the first item in the database' do
